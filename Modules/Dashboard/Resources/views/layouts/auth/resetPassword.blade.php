        ...
        <div class="col-lg-12 col-sm-12 contactus">
            ...
            <div class="form_container  bg-white ">
                ...
                <div class="login_form form-default">
                    ...
                    @endif
                    <form id="reg_form" class="row g-4" method="POST" action="{{route('submit.forget.pass.form')}}">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <button type="submit"  class="btn btn-primary w-100 theme_green font-28 pt-2 pb-2 mt-4 mb-3"
