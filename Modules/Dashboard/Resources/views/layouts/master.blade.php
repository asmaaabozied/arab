                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li class="menu-heading px-4 py-3.5 text-xs font-medium text-gray-500 cursor-default" data-key="t-menu">
                            <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{trans('employer::employer.switchToWorkerAccount')}}
                                <input type="checkbox" id="switch7" switch="info"  checked />
                                <label for="switch7" data-on-label="C" data-off-label="W"></label></h6>
                             </li>
