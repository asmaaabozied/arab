...
@endif
    ...
    <body data-mode="light" data-sidebar-size="lg">
                    ...
                    <div class="dropdown relative language hidden sm:block">
                        ...
                        <div class="dropdown-menu absolute -left-24 z-50 hidden w-40 list-none rounded bg-white shadow dark:bg-zinc-800" id="navNotifications">
                            <ul class="border border-gray-50 dark:border-gray-700" aria-labelledby="navNotifications">
                                <li>
                                    <a href="{{route('worker.change.app.language','en')}}" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-50/50 dark:text-gray-200 dark:hover:bg-zinc-600/50 dark:hover:text-white"><img src="{{asset('assets/Dashboard/assets/images/flags/us.jpg')}}" alt="user-image" class="mr-1 inline-block h-3"> <span class="align-middle">English</span></a>
                                </li>
                                <li>
                                    <a href="{{route('worker.change.app.language','ar')}}" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-50/50 dark:text-gray-200 dark:hover:bg-zinc-600/50 dark:hover:text-white"><img src="{{asset('assets/Dashboard/assets/images/flags/spain.jpg')}}" alt="user-image" class="mr-1 inline-block h-3"> <span class="align-middle">العربية</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="dropdown-menu absolute top-0 ltr:-left-3 rtl:-right-3 z-50 hidden w-40 list-none rounded bg-white shadow dark:bg-zinc-800" id="profile/log">
                                <div class="border border-gray-50 dark:border-zinc-600" aria-labelledby="navNotifications">
                                    <div class="dropdown-item dark:text-gray-100">
                                        <a class="px-3 py-2 hover:bg-gray-50/50 block dark:hover:bg-zinc-700/50" href="{{route('worker.show.my.profile')}}">
                                    ...
                                    <div class="dropdown-item dark:text-gray-100">
                                        ...
                                        <form id="logout-form" action="{{ route('worker.logout') }}" method="POST" class="d-none">
                                            @csrf
                                        </form>
                                    </div>
                                </div>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li class="menu-heading text-xs font-medium text-gray-500 cursor-default inline-flex items-center px-4 py-3.5" data-key="t-menu">
                            ...
                            <label for="switch7" data-on-label="C" data-off-label="W" class="mr-2"></label>
                            <b class="text-15 text-gray-700 dark:text-gray-100 ">{{ trans('worker::worker.switchToEmployerAccount') }}</b>
                            </b>
                        </li>

                        <li>
                            <a href="{{route('show.worker.panel')}}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                <i data-feather="home"></i>
                                <span data-key="t-dashboard"> {{trans('worker::worker.panel')}} </span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false" class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                ...
                                <span data-key="t-apps"> {{trans('worker::worker.tasks')}}</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('worker.browse.task')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.browseTask')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.tasks.in.active')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.Tasks_in_progress')}}</a>
                                </li>

                                <li>
                                    <a href="{{route('worker.tasks.in.done')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.done_tasks')}}</a>
                                </li>

                                <li>
                                    <a href="{{route('worker.tasks.in.complete')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.completed_tasks')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.tasks.in.rejected')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.rejected_tasks')}}</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false"  class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                ...
                                <span data-key="t-auth">{{trans('worker::worker.Financial Affairs')}}</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('worker.show.my.profits')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.myProfits')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.show.switch.account.to.employer.with.transfer.wallet.balance.form')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.TransferWorkerWalletBalanceToEmployer')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.show.my.wallet.history')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.WalletHistory')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.show.my.withdraw.using.paypal.form')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.WithdrawWalletBalance')}}</a>
                                </li>
                         ...
                         <li>
                            <a href="javascript: void(0);" aria-expanded="false" class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                <i data-feather="briefcase"></i><span data-key="t-pages">{{trans('worker::worker.ManagementSection')}}</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('worker.show.switching.account.history')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.switchingAccountHistory')}}</a>
                                </li>
                                <li>
                                    <a href="{{route('worker.show.my.privilege.history')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.PrivilegesHistory')}}</a>
                                </li>
                                 <li>
                                    <a href="{{route('worker.show.rule.of.privileges')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.RuleOfPrivileges')}}</a>
                                </li>
                        ...
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false"  class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                ...
                                <span data-key="t-compo">{{trans('worker::worker.SupportSection')}}</span>
                            </a>
                            <ul>
                                <?php
                                    ...
                                    ?>
                                <li>
                                    <a href="{{route('worker.show.my.tickets')}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{trans('worker::worker.myTickets')}}</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" aria-expanded="false"  class="nav-menu pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                ...
                                <span data-key="t-compo">{{trans('worker::worker.Currencies')}}</span>
                            </a>
                            <ul>
                                @if(app()->getLocale() == "ar")
                                    @foreach($currencies as $currency)
                                    <li>
                                        <a href="{{route('worker.change.app.currency',$currency->en_name)}}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">{{$currency->ar_name}}</a>
                                    </li>
                                    @endforeach
                                @else
                                @foreach($currencies as $currency)
        ...
        <div class="main-content">
            <div class="page-content dark:bg-zinc-700 min-h-screen flex items-center justify-center shadow-md ">
        ...
        <div class="hidden fixed inset-0 flex items-center justify-center z-50" id="CustomSwal">
            <div class="relative max-w-md w-full bg-white p-4 rounded-lg shadow-md" role="dialog" aria-modal="true">
                <div class="text-center text-2xl text-primary">{{ trans('worker::worker.switchAccountToEmployerTitle') }}</div>
                <div class="text-center py-4">{{ trans('worker::worker.switchAccountToEmployerText') }}</div>
                ...
                <form id="switch-account-form-worker" action="{{ route('worker.switch.account.to.employer') }}" method="POST" class="hidden">
                    @csrf
                </form>
            </div>
        </div>
