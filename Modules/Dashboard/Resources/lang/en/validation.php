...
return [
    ...
    */
    ...
    'custom_regex' => 'The :attribute must contain at least one lowercase letter, one uppercase letter, one number, and be at least 8 characters long.',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
            ...
            'title' => 'Title',
            'q' => 'Search',
            'reasonOfReject' => 'Reason for Rejection',
            'captcha' => 'Captcha Code',
            'category_id' => 'Category',
            'TaskWorkflow' => 'Task Workflow',
            'Workflow' => 'Workflow',
            'total_worker_limit' => 'Total Workers Limit',
            'task_end_date' => 'Task End Date',
            'TaskRegion' => 'Task Target Regions',
            'Country' => 'Country',
            'City' => 'City',
            'proof_request_ques' => 'Proof Request Question',
            'proof_request_screenShot' => 'Proof Request Screenshot',
            'daily_limit' => 'Daily Limit',
            'new_minimum_cost_per_worker' => 'New Cost Per Worker',
            'answer_text' => 'Proof Answer Text',
