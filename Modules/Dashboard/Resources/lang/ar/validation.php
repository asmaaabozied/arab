...
return [
    ...
    */
    ...
    'confirmed' => 'حقل تأكيد كلمة المرور غير مُطابق لحقل :attribute',
    ...
    'Error!' => 'خطأ! ',
    'captcha' => 'إن كود الكاباتشا المُدخل غير صحيح',
    'custom_regex' => 'إن كلمة المرور يجب أن تحتوي على حرف صغير وحرف كبير ورقم واحد على الأقل، وألا تنقص عن 8 أحرف',
    'Page Not Found' => 'لم يتم العثور على الصفحة',
    'The page you are looking for doesn’t exist' => 'إن الصفحة التي طلبتها غير موجودة',
    'Back to back' => 'العودة للخلف',
    '' => '',
    '' => '',
    '' => '',
    ...
    |dashboard::validation.The page you are looking for doesn’t exist
    */
    ...
    */
    ...
    'attributes' => [
        ...
        'captcha'                     => 'كود الكاباتشا',
        'category_id'                     => 'الفئة',
        'TaskWorkflow'                     => 'مراحل المهمة',
        'Workflow'                     => 'المرحلة',
        'total_worker_limit'                     => 'العدد الإجمالي للعُمال',
        'task_end_date'                     => 'تاريخ إنتهاء المهمة',
        'TaskRegion'                     => 'المناطق المٌُستهدفة في هذه المهمة',
        'Country'                     => 'الدولة',
        'City'                     => 'المدينة',
        'proof_request_ques'                     => 'السؤال الذي يثبت إنجاز المهمة',
        'proof_request_screenShot'                     => 'لقطة الشاشة التي تُثبت إنجاز المهمة',
        'daily_limit'                     => 'الحد اليومي للعُمّال',
