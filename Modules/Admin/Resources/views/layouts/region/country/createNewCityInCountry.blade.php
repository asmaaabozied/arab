    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <form class="p-2" action="{{route('admin.store.new.city.in.country',$country->id)}}" method="POST"
                    ...
                    <div class=" d-lg-flex d-md-flex justify-content-between">
                        ...
                        <a href="{{route('admin.show.cities.of.country',$country->id)}}" class="btn bg-gradient-secondary w-auto">{{trans('admin::admin.back')}}</a>
                    </div>
                </form>
            </div>
        </div>
