                    ...
                    <div class="table-responsive p-0">
                        <table class="table table-flush" id="datatable-list">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    {{trans('admin::ticket.WorkerDetails')}}
                                </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                            ...
                            @if(isset($data) && $data->count() !=0)
                                ...
                                @foreach($data as $datum)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm"><a class="text-info" href="{{route('admin.show.worker.profile',$datum->worker->id)}}">{{$datum->worker->worker_number}}</a></h6>
                                                <p class="text-xs text-secondary mb-0"><a href="{{route('admin.show.worker.profile',$datum->worker->id)}}"> {{$datum->worker->name}}</a></p>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center">
                                            @if(app()->getLocale() == "ar")
                                        ...
                                        <td class="align-middle text-center p-1">
                                            <a href="{{route('admin.show.worker.ticket.details',[$datum->id])}}"
                                               class="mx-1  text-sm"
