...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card mb-4">
                ...
                @if($data->statuses()->with('name')->latest()->first()->name->name != "Done")
                    <div class="card-footer d-block">
                        <form
                            method="POST"
                            action="{{route('admin.send.answer.to.employer.ticket',$data->id)}}"
            ...
            @endif
            <div class="button-row ">
                <a href="{{route('admin.show.employer.tickets')}}"
    ...
    <div class="swal-overlay swal-overlay--show-modal d-none" id="CustomSwal" tabindex="-1">
        <div class="swal-modal" role="dialog" aria-modal="true">
            ...
            <div class="swal-footer">
                ...
                <form id="switch-account-form" action="{{ route('admin.done.employer.ticket',$data->id) }}" method="POST" class="d-none">
                    @csrf
                </form>
            </div>
        </div>
