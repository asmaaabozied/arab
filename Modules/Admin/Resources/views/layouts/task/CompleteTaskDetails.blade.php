...
@section('content')
            ...
            <div class="card bg-gradient-secondary">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-white text-sm mb-0 text-capitalize font-weight-bold opacity-7">{{trans('employer::task.total_worker_limit')}}</p>
                                <h5 class="text-white font-weight-bolder mb-0">
    ...
    <div class="row mt-4">
        ...
        <div class="button-row ">
            <a href="{{route('admin.show.task.in.complete.status')}}"
