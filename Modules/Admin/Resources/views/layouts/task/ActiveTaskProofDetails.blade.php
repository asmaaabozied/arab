    ...
    @if($proof->isAdminAcceptProof == "NotSeenYet")
        <div class="row mt-4">
            <div class="button-row ">
                <a href="{{route('admin.accept.task.proof',[$task->id,$task->task_number,$proof->id,$proof->worker_id,$task->employer_id])}}"
        ...
        <div class="row mt-4">
            ...
            <form class="d-none"  method="Get" id="rejectForm"  action="{{route('admin.reject.task.proof',[$task->id,$task->task_number,$proof->id,$proof->worker_id,$task->employer_id])}}"
        ...
        <div class="row mt-4">
            <div class="button-row ">
                <a href="{{route('admin.show.active.tasks.proofs',[$task->id,$task->task_number])}}"
