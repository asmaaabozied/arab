...
{{--    <link id="pagestyle" href="{{asset('assets/css/admin/assets/css/avatar-uploade.css')}}" rel="stylesheet"/>--}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <form class="p-2" action="{{route('admin.update.action.of.category',$data->id)}}" method="POST"
                    ...
                    <div class=" d-lg-flex d-md-flex justify-content-between">
                        <button type="submit"
                                class="btn bg-gradient-primary w-auto">{{trans('admin::admin.update_action')}}</button>
                        <a href="{{route('admin.show.action.of.category',$data->category_id)}}" class="btn bg-gradient-secondary w-auto  ">{{trans('admin::admin.back')}}</a>
                    </div>
                </form>
            </div>
        </div>
