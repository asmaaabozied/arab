...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <form class="p-2" action="{{route('admin.update.discountCode',$data->id)}}" method="POST"
                            ...
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="type"
                                        ...
                                        @if($data->type == "MainCosts")
                                            <option class="bg-primary" selected value="{{$data->type}}">{{$data->type}}</option>
                                        ...
                                        @elseif($data->type == "AdditionalCosts")
                                            <option class="bg-primary" selected value="{{$data->type}}">{{$data->type}}</option>
                                            <option value="MainCosts">MainCosts</option>
                                            <option value="TotalCosts">TotalCosts</option>
                                            <option value="PayCosts">PayCosts</option>

                                        @elseif($data->type == "TotalCosts")
                                            <option class="bg-primary" selected value="{{$data->type}}">{{$data->type}}</option>
                                            <option value="AdditionalCosts">AdditionalCosts</option>
                                            <option value="MainCosts">MainCosts</option>
                                            <option value="PayCosts">PayCosts</option>
                                        @elseif($data->type == "PayCosts")
                                            <option class="bg-primary" selected value="{{$data->type}}">{{$data->type}}</option>
                                            <option value="AdditionalCosts">AdditionalCosts</option>
                                            <option value="TotalCosts">TotalCosts</option>
                                            <option value="MainCosts">MainCosts</option>
                            ...
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="{{trans('admin::admin.discountCode')}}"
                                           value="{{$data->code}}" name="code" type="text"
                            ...
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="0.01" step="0.01"
                                           ...
                                           value="{{$data->discount_amount}}" id="example-email-input" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="1" step="1"
                                           ...
                                           name="max_uses"
                                           value="{{$data->max_uses}}" id="example-email-input" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="1" step="1"
                                           ...
                                           name="starts_at"
                                           value="{{$data->starts_at}}" id="example-email-input" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="1" step="1"
                                           ...
                                           name="expires_at"
                                           value="{{$data->expires_at}}" id="example-email-input" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" min="1" step="1"
                                           ...
                                           name="description"
                                           value="{{$data->description}}" id="example-email-input" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class=" d-lg-flex d-md-flex justify-content-between">
                        <button type="submit"
                                class="btn bg-gradient-primary w-auto">{{trans('admin::admin.update_discount_code')}}</button>
