...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <form class="p-2" action="{{route('admin.update.currency',$data->id)}}" method="POST"
                                ...
                                <figure class="personal-figure">
                                    ...
                                    @else
                                        <img class="radius" id="output"
                                             src="{{asset('assets/img/currency/d-currency.png')}}" width="120"
                                             height="120">
                                    @endif
                    ...
                    <div class="row gx-4">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="{{trans('admin::admin.CurrencyEnName')}}"
                                       value="{{$data->en_name}}" name="ar_name" type="text"
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="{{trans('admin::admin.CurrencyArName')}}"
                                       value="{{$data->ar_name}}" name="ar_name" type="text"
                                       id="example-search-input" disabled>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="{{trans('admin::admin.CurrencyRateAgainstDollar')}}"
                                       value="{{$data->rate}}" name="rate" type="number"
                                       step="0.01"
                                       min="0.01"
                    ...
                    <div class="text-end">
                        <button type="submit"
                                class="btn bg-gradient-primary w-auto m-4 ">{{trans('admin::admin.UpdateCurrencyRate')}}</button>
                    </div>
                </form>
            </div>
        </div>
