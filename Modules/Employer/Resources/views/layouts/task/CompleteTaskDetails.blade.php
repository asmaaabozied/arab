...
@section('content')
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-md-4">
            ...
            <p class="mb-2">{{trans('employer::task.current_task_status')}} <span
                    class="badge badge-pill badge-info">{{trans('employer::task.'.$task->TaskStatuses()->latest()->first()->status()->first()->name)}}</span>
            </p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-4">
        <div class="button-row ">
            <a href="{{route('employer.show.complete.tasks.proofs',[$task->id,$task->task_number])}}"
               class="btn btn-primary btn-lg w-100   mb-2">{{trans('employer::task.show_task_proofs')}}</a>
        </div>
        <div class="button-row ">
            <a href="{{route('employer.show.task.in.complete.status')}}"
