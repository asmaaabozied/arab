...
@section('content')
                ...
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-4 text-start">
                            <img class="" style="border-radius: 18px; width: 20%"
    ...
    <div class="row justify-content-between mt-4">
        ...
        <div class="col-md-4">
            ...
            <p class="mb-2">{{trans('employer::task.current_task_status')}} <span
                    class="badge badge-pill badge-danger">{{trans('employer::task.'.$task->TaskStatuses()->latest()->first()->status()->first()->name)}}</span>
            </p>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="pt-2">
                            @for($i=0;$i<count($result);$i++)
                                <div class="d-flex my-1 align-items-center">
                                    <div class="">
                                        <a href="#!">
                                            <img class="avatar-sm "    width="50%" height="50%" src="{{Storage::url($result[$i]['flag'])}}"
    ...
    <div class="row mt-4">
        ...
        <div class="button-row ">
            <a href="{{route('employer.show.task.in.rejected.status')}}"
