...
//            'avatar' => 'nullable|image|mimes:jpg,png,jpeg,gif,svg|max:3072',
    ...
    public function messages()
    {
        return [
            ...
            'paypal_account.required' => trans('dashboard::validation.required'),
            'paypal_account.min' => trans('dashboard::validation.min'),
            'paypal_account.string' => trans('dashboard::validation.string'),
            'paypal_account.max' => trans('dashboard::validation.max'),
