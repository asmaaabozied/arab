            ...
            <div class="card">
                            ...
                            <div class=" mb-4 col-md-6 col-sm-12">
                                <div class="d-flex flex-row">
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <img src="{{asset('frontend/assets/img/Ellipse8.png')}}" class="img-fluid mb-3">
                                    </div>
                            ...
                            <div class=" mb-4 col-md-6 col-sm-12">
                                <div class="d-flex flex-row">
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <img src="{{asset('frontend/assets/img/Ellipse 9.png')}}" class="img-fluid mb-3">
                                    </div>
                ...
                <div class="row mt-4">
                    <div class="button-row ">
                        <button type="submit"
                                class="subAddTicket btn-lg w-100 text-white mb-2">{{trans('worker::worker.amountTransferredAfterFees')}}</button>
                    </div>
