...
@section('content')
                    ...
                    <div class="row align-items-center">
                        <div class="col-8">
                            <div class="numbers mx-3">
                                <p class="text-lg mb-0 text-capitalize font-weight-bold">{{trans('worker::worker.walletBalanceWorkerAccount')}}</p>
                                <h5 class="font-weight-bolder text-lg text-purple mb-0" id="worker_wallet_balance">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <div class="numbers mx-3">
                                <p class="text-lg mb-0 text-capitalize font-weight-bold">{{trans('worker::worker.fees_per_transfer_wallet_balance')}}</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <div class="numbers mx-3">
                                <p class="text-lg mb-0 text-capitalize font-weight-bold">{{trans('worker::worker.walletBalanceEmployerAccount')}}</p>
                                <h5 class="font-weight-bolder text-lg text-primary mb-0" id="employer_wallet_balance">
        ...
        <form method="POST" action="{{route('worker.switch.account.to.employer.with.transfer.wallet.balance')}}"
                                    ...
                                    <div class="card">
                                        <div class="card-body p-3">
                                            <div class="row align-items-center">
                                                <div class="col-8">
                                                    <div class="numbers mx-3">
                                                        <p class="text-lg mb-0 text-capitalize font-weight-bold">{{trans('worker::worker.amountTransferredAfterFees')}}</p>
            ...
            <div class="row mt-4">
                <div class="button-row ">
                    <button type="submit"
                            class="btn btn-primary text-white btn-lg w-100   mb-2">{{trans('worker::worker.SwitchAccountAndTransferWalletBtn')}}</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        $(document).on('input', '#amount_input', function () {
            ...
            document.getElementById("worker_wallet_balance").innerHTML = Number(WorkerWalletBalance - Amount ).toFixed(2) + " USD";
            document.getElementById("employer_wallet_balance").innerHTML = Number((EmployerWalletBalance + (Amount - (Amount * fees / 100))) .toFixed(2)) + " USD";
