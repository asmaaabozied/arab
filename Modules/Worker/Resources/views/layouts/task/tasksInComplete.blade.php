            ...
            <div class="table-responsive PrivilageRuler p-3">
                <table class="table align-items-center table-flush" id="PrivilageRuler">
                    ...
                    <tr>
                        ...
                        <th>{{trans('worker::task.proof_accepted_at')}}</th>
                        ...
                        @foreach($data as $datum)
                            <tr>
                                ...
                                <td class="text-sm text-center">
                                    <a href="{{route('worker.show.task.in.complete.details',[$datum->task->id,$datum->task->task_number])}}" class="mx-1"
                    ...
                    @else
                        <td colspan="7">
                            <div class="text-warning text-center">{{trans('worker::task.You dont have  done  task ')}}</div>
                        </td>
                    @endif
                    </tbody>
