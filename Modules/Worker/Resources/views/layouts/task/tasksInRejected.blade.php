            ...
            <div class="table-responsive PrivilageRuler p-3">
                <table class="table align-items-center table-flush" id="PrivilageRuler">
                    ...
                    <tr>
                        ...
                        <th>{{trans('worker::task.proof_rejected_at')}}</th>
                    ...
                    @if(isset($data) and count($data) > 0)
                        ...
                        @foreach($data as $datum)
                            <tr>
                                ...
                                <td><span class="badge badge-danger">{{$datum->updated_at->diffForHumans()}}</span></td>
                                <td>
                                    <span
                                ...
                                <td>
                                    <a href="{{route('worker.show.task.in.rejected.details',[$datum->task->id,$datum->task->task_number])}}" class="mx-1"
                    ...
                    @else
                        <td colspan="7">
                            <div class="text-warning text-center">{{trans('worker::task.You dont have  rejected  task')}}</div>
                        </td>
                    @endif
                    </tbody>
                </table>
