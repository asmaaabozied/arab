            ...
            <div class="row">
                <div class="col-12">
                    <div class="card {{"prof_".$proof->isEmployerAcceptProof}}">
                        ...
                        @if($proof->isEmployerAcceptProof == "No")
                        ...
                        <div class="card-body p-3 text-center">
                            <div class="row">
                                <div class="col-12 my-auto">
                                    <div class="numbers">
                                        <p class="text-white text-sm mb-0 text-capitalize font-weight-bold opacity-7">
                                            {{trans('worker::task.reasonOfEmployerRefuse')}}
                                        </p>
                                        <h5 class="text-white font-weight-bolder weather-line mb-0">
                                            @if($proof->reasonOfEmployerRefuse != null)
                                                {{$proof->reasonOfEmployerRefuse}}
                                            @else
                                                {{trans('worker::task.It was rejected for some unknown reason')}}
                                            @endif
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        @if($proof->isAdminAcceptProof == "No")--}}
{{--                            <hr class="horizontal dark">--}}
{{--                            <div class="card-body p-3 text-center">--}}
{{--                                <div class="row">--}}
{{--                                    <div class="col-12 my-auto">--}}
...
{{--                                            </p>--}}
{{--                                            <h5 class="text-white font-weight-bolder weather-line mb-0">--}}
{{--                                                @if($proof->reasonOfAdminRefuse != null)--}}
{{--                                                    {{$proof->reasonOfAdminRefuse}}--}}
{{--                                                @else--}}
{{--                                                    {{trans('worker::task.It was rejected for some unknown reason')}}--}}
{{--                                                @endif--}}
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-12 mt-md-4 mt-4">
            ...
            <div class="text-center">
                <a href="{{route('worker.tasks.in.rejected')}}"
